...
contract SimplePayment_v1_o_up {
    ...
    function calculateTotalUsage(
        ...
        uint32 prevPeakODO = prevOdo.initialized ? prevOdo.peakODO : 1;
        uint32 prevStdODO = prevOdo.initialized ? prevOdo.stdODO : 1;
        uint32 prevOffODO = prevOdo.initialized ? prevOdo.offODO : 1;
